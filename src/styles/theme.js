  ...
  const darkTheme = {
    ...
    components: {
      ...
      button: {
        ...
        fitbit_connect: 'w-full px-6 py-3 text-lg font-semibold rounded-xl bg-gradient-to-r from-[#00B0B9]/40 via-[#00B0B9]/20 to-[#111827]/80 text-white border-2 border-[#00B0B9]/50 shadow-[0_0_12px_2px_rgba(0,176,185,0.3)] hover:shadow-[0_0_16px_4px_rgba(0,176,185,0.35)] hover:bg-gradient-to-r hover:from-[#00B0B9]/50 hover:via-[#00B0B9]/30 hover:to-[#1e293b]/80 hover:border-[#00B0B9]/60 hover:scale-[1.02] active:scale-95 transition-all backdrop-blur disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3',
        strava_connect: 'w-full px-6 py-3 text-lg font-semibold rounded-xl bg-gradient-to-r from-[#FC4C02]/40 via-[#FC4C02]/20 to-[#111827]/80 text-white border-2 border-[#FC4C02]/50 shadow-[0_0_12px_2px_rgba(252,76,2,0.3)] hover:shadow-[0_0_16px_4px_rgba(252,76,2,0.35)] hover:bg-gradient-to-r hover:from-[#FC4C02]/50 hover:via-[#FC4C02]/30 hover:to-[#1e293b]/80 hover:border-[#FC4C02]/60 hover:scale-[1.02] active:scale-95 transition-all backdrop-blur disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3'
      },
      input: {
  ...
  const lightTheme = {
    ...
    components: {
      ...
      button: {
        ...
        fitbit_connect: 'w-full px-6 py-3 text-lg font-semibold rounded-xl bg-gradient-to-r from-[#00B0B9]/10 via-white to-[#00B0B9]/5 text-[#00B0B9] border-2 border-[#00B0B9]/30 shadow-[0_2px_8px_rgba(0,176,185,0.1)] hover:shadow-[0_4px_12px_rgba(0,176,185,0.2)] hover:bg-gradient-to-r hover:from-[#00B0B9]/15 hover:via-gray-50 hover:to-[#00B0B9]/10 hover:border-[#00B0B9]/50 hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3',
        strava_connect: 'w-full px-6 py-3 text-lg font-semibold rounded-xl bg-gradient-to-r from-[#FC4C02]/10 via-white to-[#FC4C02]/5 text-[#FC4C02] border-2 border-[#FC4C02]/30 shadow-[0_2px_8px_rgba(252,76,2,0.1)] hover:shadow-[0_4px_12px_rgba(252,76,2,0.2)] hover:bg-gradient-to-r hover:from-[#FC4C02]/15 hover:via-gray-50 hover:to-[#FC4C02]/10 hover:border-[#FC4C02]/50 hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3'
      },
      input: {
